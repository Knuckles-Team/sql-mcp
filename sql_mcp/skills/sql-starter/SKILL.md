...
name: sql-starter
description: >-
  Sql API + MCP Server + A2A Server Use when working with Sql via this package's MCP
...
Starter skill for the **Sql** package. Use the `mcp-client` universal skill
